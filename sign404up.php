				...
				<div class="modal-footer">
					...
					<!-- <div id="myButtons3" >
						<button type="button"  class="btn btn-primary" 
							data-loading-text="Loading...">reset
						</button>
					</div> -->
		...
		<div class="container" style=" display: flex; align-items: center;  justify-content: center; ">
					...
					<div class="myform">
						...
						<div>
							...
							<br />
							<div class="signup fh5co-pricing-table signup">
								...
								<form action="" class="" method="post">
								    ...
								    <div style="text-align: center;">
								        ...
								        <div style="text-align: center;">
								            ...
								            <input  id="username" name="username" class="form-control" placeholder="输入你的用户名" maxlength="20" type="text">
								        </div>
								
								        <div style="color:red;" id="tip1" class="tips"><?php echo $error1; ?></div>
								    ...
								    <div style="text-align: center;">
								        ...
								        <div style="text-align: center;">
								            ...
								            <input  id="password1" name="password1" class="form-control" placeholder="输入密码" maxlength="20" type="password">
								        </div>
								
								        <div style="color:red;" id="tip2" class="tips"><?php echo $error2; ?></div>
									...
									<div style="text-align: center;">
									    ...
									    <div style="text-align: center;">
									        ...
									        <input  id="password2" name="password2" class="form-control" placeholder="再次输入密码" maxlength="20" type="password">
									    </div>
																	
									    <div style="color:red;" id="tip3" class="tips"><?php echo $error3; ?></div>
								    ...
								    <div class="form-group"  style="margin-top:5% ;">
										...
										<button name="submit" id="submit" type="submit"  class="btn btn-block btn-sm btn-primary">去登录</button>
								    </div>
