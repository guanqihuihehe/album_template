...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<meta name="author" content="" />
	  ...
	  <!-- Facebook and Twitter integration -->
		...
		<!-- <link href='http://fonts.useso.com/css?family=Montserrat:400,700' rel='stylealbumet' type='text/css'> -->
								...
								<form action="" class="" method="post">
								    ...
								    <div style="text-align: center;">
								        ...
								        <div style="text-align: center;">
								            ...
								            <input  id="username" name="username" class="form-control" placeholder="输入用户名" maxlength="20" type="text">
								        </div>
								
								        <div style="color:red;" class="tips"><?php echo $error; ?></div>
								    ...
								    <div style="text-align: center;">
								        ...
								        <div style="text-align: center;">
								            ...
								            <input  id="password" name="password" class="form-control" placeholder="输入密码" maxlength="20" type="password">
								        </div>
								    ...
								    <div class="form-group"  style="margin-top:5% ;">
										...
										<button name="submit" id="submit" type="submit" class="btn btn-block btn-sm btn-primary">登录</button>
								    </div>
